...
- 权威源：父仓库根目录 `assets\go_projects\go-default.ico`（go.dev 站标地鼠，含 16/24/32/48/64/128/256 共 7 帧）。
...
1. 复制图标到新项目主包目录：
   ...
   ```powershell
   Copy-Item D:\Users\language_projects\assets\go_projects\go-default.ico D:\Users\language_projects\go_projects\<项目>\cmd\<工具>\icon.ico
   ```
